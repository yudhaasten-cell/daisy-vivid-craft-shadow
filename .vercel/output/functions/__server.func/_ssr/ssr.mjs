...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DXJVFVAZ.mjs");
...
var manifest = {
	"170da1877c1360996bb9d0b6bae461cd64ea02752261f0c1e8d2a0583f258a76": {
		functionName: "fetchQuotes_createServerFn_handler",
		importer: () => import("./quotes-Cvn0C97X.mjs")
	},
	"287dc15e29d6798168edbf699c25bc7e27c765933b054279272bcae99aa90240": {
		functionName: "writeDeskNote_createServerFn_handler",
		importer: () => import("./desk-note-CZJz60W0.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BXtc3LLs.mjs").then((n) => n.t),
